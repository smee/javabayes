 ...
 */
public static InferenceGraphNode createNode(
 ...
 */
public static void setProbabilityValues(InferenceGraphNode node, double trueValue, double falseValue) {
 ...
 */
public static int getVariableIndex(InferenceGraphNode node, String parentVariable) {
 ...
 */
public static int getTotalValues(InferenceGraphNode node, String parentVariable) {
	for (InferenceGraphNode parent : (Vector<InferenceGraphNode>) node.get_parents()) {
 ...
 */
public static void setProbabilityValues(InferenceGraphNode node, String parentVariable, 
 ...
 */
public static void setProbabilityValues(InferenceGraphNode node, String firstParentVariable, 
 ...
 */
public static double getBelief(InferenceGraph ig, InferenceGraphNode node) {
...
public static void main(String[] args) {
	...
	System.out.println(getBelief(ig,dogOut));
}
}
